          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuAttr in spuSaleAttrList" :key="spuAttr.id">
                ...
                <dd changepirce="0" :class="{active:baseAttr.isChecked==1}" v-for="baseAttr in spuAttr.spuSaleAttrValueList" :key="baseAttr.id" @click="changeIsChecked(baseAttr,spuAttr.spuSaleAttrValueList)">{{baseAttr.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      {
        try {
          await this.$store.dispatch("getGoodsInfo",{skuId:this.skuInfo.id,skuNum:this.skuNum})
